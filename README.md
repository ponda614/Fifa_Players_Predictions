...
|--|--|
||We will be working with Fifa world players dataset that we found on Kaggle website, </br>is a public web-based data-science environment: FIFA_World_players_full_data.csv.</br>We chose this dataset because: <li>it appears complete, it lists lots of player features,</li><li>its content allows us to apply the transformation mechanisms and cleanse the datat,</li><li>and we all have a common passion for the game that may translate into a diverse analysis.</li>|
